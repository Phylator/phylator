class CalculationsController < ApplicationController
    ...
    def calculation_params
        params.require(:calculation).permit(:user_id, :quantity_id, :unit_of_measurement_id, :name, :public, measurements_attributes: [:value, :margin_of_error, :quantity_id, :unit_of_measurement_id])
    end

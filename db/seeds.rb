...
kinematics = Pack.find_or_create_by! category: mechanics, name: 'Kinematics', description: 'Description', price: 1
dynamics = Pack.find_or_create_by! category: mechanics, name: 'Dynamics', description: 'Description', price: 1
...
thermodynamics_advanced = Pack.find_or_create_by! category: thermodynamics, name: 'Advanced', description: 'Description', price: 2
...
electricity = Pack.find_or_create_by! category: electromagnetism, name: 'Electricity', description: 'Description', price: 4
magnetism = Pack.find_or_create_by! category: electromagnetism, name: 'Magnetism', description: 'Description', price: 2
optics = Pack.find_or_create_by! category: electromagnetism, name: 'Optics', description: 'Description', price: 2
...
quantum_mechanics_basics = Pack.find_or_create_by! category: quantum_mechanics, name: 'Basics', description: 'Description', price: 1
chemical_physics = Category.find_or_create_by! name: 'Chemical physics', description: 'Description'
chemical_physics_basics = Pack.find_or_create_by! category: chemical_physics, name: 'Basics', description: 'Description', price: 2
chemical_physics_advanced = Pack.find_or_create_by! category: chemical_physics, name: 'Advanced', description: 'Description', price: 2




# Length (Mechanics)
length = Quantity.find_or_create_by! symbol: 'l', name: 'Length', description: 'The one-dimensional extent of an object', wikipedia: 'https://en.wikipedia.org/wiki/Distance', pack: mechanics_basics
...
distance_traveled = Quantity.find_or_create_by! symbol: 's', name: 'Distance traveled', description: 'Distance an object traveled', wikipedia: 'https://en.wikipedia.org/wiki/Distance', pack: mechanics_basics, parent_quantity: length
...
# Mass (Mechanics)
mass = Quantity.find_or_create_by! symbol: 'm', name: 'Mass', description: 'A measure of resistance to acceleration', wikipedia: 'https://en.wikipedia.org/wiki/Mass', pack: mechanics_basics
...
# Time (Mechanics)
time = Quantity.find_or_create_by! symbol: 't', name: 'Time', description: 'The duration of an event', wikipedia: 'https://en.wikipedia.org/wiki/Time_in_physics', pack: mechanics_basics
...
electric_current = Quantity.find_or_create_by! symbol: 'I', name: 'Electric current', description: 'Rate of flow of electrical charge per unit time', wikipedia: 'https://en.wikipedia.org/wiki/Electric_current', pack: electromagnetism_basics
...
temperature = Quantity.find_or_create_by! symbol: 'T', name: 'Temperature', description: 'Average kinetic energy per degree of freedom of a system', wikipedia: 'https://en.wikipedia.org/wiki/Temperature', pack: thermodynamics_basics
...
amount_of_substance = Quantity.find_or_create_by! symbol: 'n', name: 'Amount of substance', description: 'Number of particles compared to the number of atoms in 0.012 kg of 12C', wikipedia: 'https://en.wikipedia.org/wiki/Amount_of_substance', pack: chemical_physics_basics
...
luminous_intensity = Quantity.find_or_create_by! symbol: 'L', name: 'Luminous intensity', description: 'Wavelength-weighted power of emitted light per unit solid angle', wikipedia: 'https://en.wikipedia.org/wiki/Luminous_intensity', pack: optics
...
quantum_mechanics.update_attributes name: 'Quantenmechanik', description: 'Beschreibung', locale: :de
